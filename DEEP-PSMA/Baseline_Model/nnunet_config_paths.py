...
nnunet_data_folder=join(os.path.dirname(__file__),'data','nnUNet_data') #default nnUnet dataset folder, relative to this file location
...
dataset_dictionary={'PSMA':801,'FDG':802}
